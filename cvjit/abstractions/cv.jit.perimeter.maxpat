{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 15.0, 55.0, 534.0, 352.0 ],
		"bglocked" : 0,
		"defrect" : [ 15.0, 55.0, 534.0, 352.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 211.0, 157.0, 111.0, 18.0 ],
					"numinlets" : 1,
					"id" : "obj-17",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"linecount" : 3,
					"fontsize" : 9.0,
					"patching_rect" : [ 211.0, 114.5, 243.0, 38.0 ],
					"numinlets" : 1,
					"id" : "obj-18",
					"fontname" : "Arial",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"frgb" : [ 0.0, 0.0, 0.0, 0.901961 ],
					"patching_rect" : [ 346.0, 92.0, 105.0, 18.0 ],
					"numinlets" : 1,
					"id" : "obj-19",
					"fontname" : "Arial",
					"textcolor" : [ 0.0, 0.0, 0.0, 0.901961 ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"patching_rect" : [ 211.0, 90.0, 135.0, 20.0 ],
					"numinlets" : 1,
					"id" : "obj-22",
					"fontname" : "Arial",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"border" : 1,
					"patching_rect" : [ 206.0, 85.0, 250.0, 95.0 ],
					"numinlets" : 1,
					"id" : "obj-49",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"hidden" : 1,
					"patching_rect" : [ 227.0, 188.0, 102.0, 18.0 ],
					"numinlets" : 0,
					"id" : "obj-5",
					"fontname" : "Arial",
					"numoutlets" : 3,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"hidden" : 1,
					"patching_rect" : [ 227.0, 208.379517, 143.5, 18.0 ],
					"numinlets" : 4,
					"id" : "obj-10",
					"fontname" : "Arial",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"text" : "cv.jit.mass",
					"fontsize" : 9.0,
					"patching_rect" : [ 105.0, 129.0, 60.0, 17.0 ],
					"numinlets" : 1,
					"id" : "obj-6",
					"fontname" : "Arial",
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"text" : "cv.jit.binedge",
					"fontsize" : 9.0,
					"patching_rect" : [ 105.0, 98.0, 70.0, 17.0 ],
					"numinlets" : 1,
					"id" : "obj-7",
					"fontname" : "Arial",
					"numoutlets" : 2,
