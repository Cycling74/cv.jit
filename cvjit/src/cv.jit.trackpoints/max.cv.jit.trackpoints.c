...
{	
	...
	setup((t_messlist **)&max_cv_jit_trackpoints_class, (method)max_cv_jit_trackpoints_new, (method)max_cv_jit_trackpoints_free, (short)sizeof(t_max_cv_jit_trackpoints), 
		0L, A_GIMME, 0);
