{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 244.0, 50.0, 1037.0, 776.0 ],
		"bgcolor" : [ 0.94902, 0.917647, 0.901961, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 244.0, 50.0, 1037.0, 776.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"hidden" : 1,
					"numoutlets" : 3,
					"patching_rect" : [ 64.0, 484.0, 117.0, 18.0 ],
					"id" : "obj-1",
...
, 			{
				"box" : 				{
					...
					"hidden" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 64.0, 508.546204, 165.5, 18.0 ],
					"id" : "obj-10",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 4
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 554.0, 129.0, 77.0, 16.0 ],
					"id" : "obj-30",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"linecount" : 9,
					"numoutlets" : 0,
					"patching_rect" : [ 660.0, 406.0, 128.0, 110.0 ],
					"id" : "obj-13",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"patching_rect" : [ 325.0, 409.0, 205.0, 18.0 ],
					"id" : "obj-8",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 370.0, 101.0, 18.0 ],
					"id" : "obj-7",
					"outlettype" : [ "jit_matrix", "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"text" : "Output",
					"numoutlets" : 0,
					"patching_rect" : [ 55.5, 308.0, 44.0, 19.0 ],
					"id" : "obj-31",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "Input",
					"numoutlets" : 0,
					"patching_rect" : [ 60.0, 261.0, 35.0, 19.0 ],
					"id" : "obj-34",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"patching_rect" : [ 110.0, 261.0, 175.0, 19.0 ],
					"id" : "obj-37",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"linecount" : 4,
					"numoutlets" : 0,
					"patching_rect" : [ 110.0, 289.0, 175.0, 57.0 ],
					"id" : "obj-38",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 50.0, 256.0, 55.0, 95.0 ],
					"border" : 1,
					"id" : "obj-39",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 50.0, 284.0, 240.0, 67.0 ],
					"border" : 1,
					"id" : "obj-42",
					"bordercolor" : [ 1.0, 1.0, 1.0, 0.647059 ],
					"rounded" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"bgcolor" : [ 0.615686, 0.607843, 0.607843, 0.2 ],
					"patching_rect" : [ 50.0, 256.0, 240.0, 29.0 ],
					"border" : 1,
					"id" : "obj-44",
					"bordercolor" : [ 1.0, 1.0, 1.0, 0.647059 ],
					"rounded" : 0,
...
, 			{
				"box" : 				{
					...
					"linecount" : 11,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 95.0, 244.0, 146.0 ],
					"id" : "obj-62",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 45.0, 90.0, 250.0, 156.0 ],
					"border" : 1,
					"id" : "obj-65",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"bgcolor" : [ 1.0, 1.0, 1.0, 0.403922 ],
					"patching_rect" : [ 45.0, 251.0, 250.0, 105.0 ],
					"border" : 1,
					"id" : "obj-5",
					"bordercolor" : [ 0.0, 0.0, 0.0, 0.517647 ],
					"rounded" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 315.0, 366.0, 117.0, 26.0 ],
					"border" : 1,
					"id" : "obj-9",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 315.0, 399.0, 481.0, 128.0 ],
					"border" : 1,
					"id" : "obj-66",
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Find connected component centers of mass",
					"numoutlets" : 0,
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-8", 1 ],
					"hidden" : 0,
					"midpoints" : [ 334.5, 308.0, 520.5, 308.0 ]
				}
