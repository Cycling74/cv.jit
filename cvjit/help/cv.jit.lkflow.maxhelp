{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 319.0, 44.0, 1029.0, 753.0 ],
		"bgcolor" : [ 0.941176, 0.917647, 0.886275, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 319.0, 44.0, 1029.0, 753.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"maximum" : 7,
					"patching_rect" : [ 644.0, 240.0, 48.0, 18.0 ],
					"id" : "obj-32",
					"outlettype" : [ "int", "bang" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 410.0, 363.0, 408.0, 29.0 ],
					"id" : "obj-28",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"patching_rect" : [ 325.0, 369.0, 76.0, 18.0 ],
					"id" : "obj-13",
...
, 			{
				"box" : 				{
					...
					"linecount" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 708.0, 238.0, 207.0, 41.0 ],
					"id" : "obj-21",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "radius $1",
					"numoutlets" : 1,
					"patching_rect" : [ 644.0, 266.0, 52.0, 16.0 ],
					"id" : "obj-24",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"text" : "cv.jit.lkflow",
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 325.0, 58.0, 18.0 ],
					"id" : "obj-11",
					"outlettype" : [ "jit_matrix", "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 272.0, 118.0, 18.0 ],
					"id" : "obj-8",
					"outlettype" : [ "jit_matrix", "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"linecount" : 5,
					"numoutlets" : 0,
					"patching_rect" : [ 475.0, 233.0, 141.0, 70.0 ],
					"id" : "obj-7",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "Output",
					"numoutlets" : 0,
					"patching_rect" : [ 55.5, 250.5, 44.0, 19.0 ],
					"id" : "obj-31",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"linecount" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 110.0, 238.0, 175.0, 44.0 ],
					"id" : "obj-38",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 50.0, 205.0, 55.0, 82.0 ],
					"border" : 1,
					"id" : "obj-39",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 50.0, 233.0, 240.0, 54.0 ],
					"border" : 1,
					"id" : "obj-42",
					"bordercolor" : [ 1.0, 1.0, 1.0, 0.647059 ],
					"rounded" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"varname" : "comments",
					"text" : "cv.jit.lkflow computes the optical flow of an incoming greyscale matrix using the Lucas-Kanade technique.\n\nQuality can be controled via the \"radius\" attribute, although large values will result in a heavier CPU load.",
					"linecount" : 7,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 95.0, 240.0, 95.0 ],
					"id" : "obj-62",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"bgcolor" : [ 1.0, 1.0, 1.0, 0.403922 ],
					"patching_rect" : [ 45.0, 200.0, 250.0, 92.0 ],
					"border" : 1,
					"id" : "obj-5",
					"bordercolor" : [ 0.0, 0.0, 0.0, 0.517647 ],
					"rounded" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 316.0, 321.0, 89.0, 26.0 ],
					"border" : 1,
					"id" : "obj-9",
...
, 			{
				"box" : 				{
					"maxclass" : "jit.fpsgui",
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 666.0, 80.0, 36.0 ],
					"id" : "obj-70",
					"outlettype" : [ "", "" ],
					"fontname" : "Arial",
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"text" : "jit.rgb2luma",
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 244.0, 62.0, 18.0 ],
					"id" : "obj-69",
					"outlettype" : [ "jit_matrix", "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 413.0, 320.0, 240.0 ],
					"id" : "obj-67",
					"outlettype" : [ "", "" ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 638.0, 228.0, 290.0, 78.0 ],
					"border" : 1,
					"id" : "obj-66",
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Use the Lucas-Kanade algorithm to estimate dense optical flow",
					"numoutlets" : 0,
					"frgb" : [ 0.258824, 0.258824, 0.258824, 1.0 ],
					"patching_rect" : [ 45.0, 45.0, 570.0, 29.0 ],
					"id" : "obj-16",
					"fontname" : "Arial",
					"fontsize" : 20.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 317.0, 405.0, 336.0, 256.0 ],
					"border" : 1,
					"id" : "obj-147",
					"bordercolor" : [ 0.501961, 0.501961, 0.501961, 1.0 ],
					"rounded" : 15,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"bgcolor" : [ 1.0, 1.0, 1.0, 0.396078 ],
					"patching_rect" : [ 315.0, 354.0, 529.0, 45.0 ],
					"border" : 1,
					"id" : "obj-29",
					"bordercolor" : [ 1.0, 0.0, 0.0, 0.647059 ],
					"rounded" : 0,
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 653.5, 312.0, 334.5, 312.0 ]
				}
