{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 313.0, 70.0, 1029.0, 753.0 ],
		"bgcolor" : [ 0.941176, 0.937255, 0.894118, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 313.0, 70.0, 1029.0, 753.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 667.0, 244.0, 35.0, 18.0 ],
					"id" : "obj-89",
					"outlettype" : [ "int", "bang" ],
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"bgcolor" : [ 0.866667, 0.866667, 0.866667, 1.0 ],
					"patching_rect" : [ 667.0, 294.0, 35.0, 18.0 ],
					"id" : "obj-90",
					"outlettype" : [ "int", "bang" ],
					"fontname" : "Arial",
					"htextcolor" : [ 0.870588, 0.870588, 0.870588, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "maxlines $1",
					"numoutlets" : 1,
					"patching_rect" : [ 667.0, 318.0, 71.0, 16.0 ],
					"id" : "obj-91",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"text" : "threshold $1",
					"numoutlets" : 1,
					"patching_rect" : [ 667.0, 267.0, 72.0, 16.0 ],
					"id" : "obj-92",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"linecount" : 7,
					"numoutlets" : 0,
					"patching_rect" : [ 741.0, 248.0, 137.0, 87.0 ],
					"id" : "obj-93",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 538.0, 369.0, 335.0, 29.0 ],
					"id" : "obj-88",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"patching_rect" : [ 325.0, 375.0, 207.0, 18.0 ],
					"id" : "obj-86",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "cv.jit.hough2lines 320 240",
					"numoutlets" : 1,
					"patching_rect" : [ 325.0, 339.0, 126.0, 18.0 ],
					"id" : "obj-75",
					"outlettype" : [ "jit_matrix" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 317.0, 407.0, 336.0, 259.0 ],
					"border" : 1,
					"id" : "obj-12",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "cv.jit.hough @rho 11.2 @theta 0.03142",
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 308.0, 185.0, 18.0 ],
					"id" : "obj-8",
					"outlettype" : [ "jit_matrix", "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"text" : "Convert to greyscale, use Canny algorithm to find edges and compute Hough space.",
					"linecount" : 4,
					"numoutlets" : 0,
					"patching_rect" : [ 485.0, 242.0, 139.0, 57.0 ],
					"id" : "obj-7",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"linecount" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 653.5, 243.0, 38.0 ],
					"id" : "obj-18",
					"fontname" : "Arial",
					"fontsize" : 9.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"linecount" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 604.0, 135.0, 48.0 ],
					"id" : "obj-22",
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "Output",
					"numoutlets" : 0,
					"patching_rect" : [ 55.5, 409.5, 44.0, 19.0 ],
					"id" : "obj-31",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "Input",
					"numoutlets" : 0,
					"patching_rect" : [ 60.0, 337.0, 35.0, 19.0 ],
					"id" : "obj-34",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"patching_rect" : [ 110.0, 337.0, 175.0, 19.0 ],
					"id" : "obj-37",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "4-plane float32\n\nPlane 1: always 0\nPlane 2: y-coordinate at x=0\nPlane 3: always equals width of source image\nPlane 4: y-coordinate at x=image width",
					"linecount" : 8,
					"numoutlets" : 0,
					"patching_rect" : [ 110.0, 365.0, 175.0, 108.0 ],
					"id" : "obj-38",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 50.0, 332.0, 55.0, 146.0 ],
					"border" : 1,
					"id" : "obj-39",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 50.0, 360.0, 240.0, 118.0 ],
					"border" : 1,
					"id" : "obj-42",
					"bordercolor" : [ 1.0, 1.0, 1.0, 0.647059 ],
					"rounded" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"bgcolor" : [ 0.615686, 0.607843, 0.607843, 0.2 ],
					"patching_rect" : [ 50.0, 332.0, 240.0, 29.0 ],
					"border" : 1,
					"id" : "obj-44",
					"bordercolor" : [ 1.0, 1.0, 1.0, 0.647059 ],
					"rounded" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 45.0, 599.0, 251.0, 117.0 ],
					"border" : 1,
					"id" : "obj-49",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 45.0, 90.0, 250.0, 232.0 ],
					"border" : 1,
					"id" : "obj-65",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"bgcolor" : [ 1.0, 1.0, 1.0, 0.403922 ],
					"patching_rect" : [ 45.0, 327.0, 250.0, 156.0 ],
					"border" : 1,
					"id" : "obj-5",
					"bordercolor" : [ 0.0, 0.0, 0.0, 0.517647 ],
					"rounded" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 322.0, 335.0, 142.0, 25.0 ],
					"border" : 1,
					"id" : "obj-9",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"mode" : 3,
					"patching_rect" : [ 325.0, 669.0, 80.0, 36.0 ],
					"id" : "obj-70",
					"outlettype" : [ "", "" ],
					"fontname" : "Arial",
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Find straight lines from Hough space",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 317.0, 228.0, 311.0, 103.0 ],
					"border" : 1,
					"id" : "obj-141",
					"bordercolor" : [ 0.501961, 0.501961, 0.501961, 1.0 ],
					"rounded" : 15,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 318.0, 363.0, 568.0, 40.0 ],
					"border" : 1,
					"id" : "obj-66",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"bgcolor" : [ 1.0, 1.0, 1.0, 0.396078 ],
					"patching_rect" : [ 655.0, 234.0, 231.0, 114.0 ],
					"border" : 1,
					"id" : "obj-94",
					"bordercolor" : [ 1.0, 0.0, 0.0, 0.647059 ],
					"rounded" : 0,
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 334.5, 303.0, 522.5, 303.0 ]
				}
