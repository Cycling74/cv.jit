{
	"patcher" : 	{
		...
		"bgcolor" : [ 0.945098, 0.921569, 0.898039, 1.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"hidden" : 1,
					"numoutlets" : 3,
					"patching_rect" : [ 71.0, 494.0, 117.0, 18.0 ],
					"id" : "obj-3",
...
, 			{
				"box" : 				{
					...
					"hidden" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 71.0, 518.546204, 165.5, 18.0 ],
					"id" : "obj-5",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 4
...
, 			{
				"box" : 				{
					...
					"text" : "Output",
					"numoutlets" : 0,
					"patching_rect" : [ 55.5, 213.0, 44.0, 19.0 ],
					"id" : "obj-31",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "Input",
					"numoutlets" : 0,
					"patching_rect" : [ 60.0, 178.5, 35.0, 19.0 ],
					"id" : "obj-34",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 110.0, 172.0, 175.0, 32.0 ],
					"id" : "obj-37",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"patching_rect" : [ 110.0, 213.0, 175.0, 19.0 ],
					"id" : "obj-38",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 50.0, 208.0, 240.0, 29.0 ],
					"border" : 1,
					"id" : "obj-42",
					"bordercolor" : [ 1.0, 1.0, 1.0, 0.647059 ],
					"rounded" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"bgcolor" : [ 0.615686, 0.607843, 0.607843, 0.2 ],
					"patching_rect" : [ 50.0, 167.0, 240.0, 42.0 ],
					"border" : 1,
					"id" : "obj-44",
					"bordercolor" : [ 1.0, 1.0, 1.0, 0.647059 ],
					"rounded" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"varname" : "comments",
					"text" : "Marks as ON only pixels that are themselves ON and have a least one OFF neighbour. In other words, it returns only the edges in a binary image.",
					"linecount" : 4,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"text" : "Binary edges",
					"numoutlets" : 0,
					"patching_rect" : [ 913.0, 348.0, 69.0, 18.0 ],
					"id" : "obj-13",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "Binary image",
					"numoutlets" : 0,
					"patching_rect" : [ 570.0, 348.0, 69.0, 18.0 ],
					"id" : "obj-12",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "cv.jit.binedge",
					"numoutlets" : 2,
					"patching_rect" : [ 668.0, 305.0, 69.0, 18.0 ],
					"id" : "obj-7",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"patching_rect" : [ 668.0, 371.0, 320.0, 240.0 ],
					"id" : "obj-79",
					"outlettype" : [ "", "" ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "jit.fpsgui",
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 637.0, 80.0, 33.0 ],
					"id" : "obj-70",
					"outlettype" : [ "", "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "jit.pwindow",
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 371.0, 320.0, 240.0 ],
					"id" : "obj-67",
					"outlettype" : [ "", "" ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 657.0, 341.0, 339.0, 282.0 ],
					"border" : 1,
					"id" : "obj-1",
					"bordercolor" : [ 0.5, 0.5, 0.5, 0.5 ],
					"rounded" : 15,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"bgcolor" : [ 0.0, 0.0, 0.0, 0.101961 ],
					"patching_rect" : [ 316.0, 341.0, 339.0, 282.0 ],
					"border" : 1,
					"id" : "obj-147",
					"bordercolor" : [ 0.5, 0.5, 0.5, 0.5 ],
					"rounded" : 15,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 654.0, 300.0, 98.0, 27.0 ],
					"border" : 1,
					"id" : "obj-9",
