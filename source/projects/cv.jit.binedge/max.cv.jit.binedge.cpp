...
typedef struct _max_cv_jit_binedge {
	t_object		ob;
	void			*obex;
} t_max_cv_jit_binedge;

t_jit_err cv_jit_binedge_init(void); 

void *max_cv_jit_binedge_new(t_symbol *s, long argc, t_atom *argv);
void max_cv_jit_binedge_free(t_max_cv_jit_binedge *x);

void *max_cv_jit_binedge_class;
...
void *max_cv_jit_binedge_new(t_symbol *s, long argc, t_atom *argv)
{
	t_max_cv_jit_binedge *x = (t_max_cv_jit_binedge*)max_jit_obex_new(max_cv_jit_binedge_class, gensym("cv_jit_binedge"));
	void *o;
