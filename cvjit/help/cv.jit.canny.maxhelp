{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 377.0, 44.0, 1018.0, 764.0 ],
		"bgcolor" : [ 0.945098, 0.913725, 0.866667, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 377.0, 44.0, 1018.0, 764.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"hidden" : 1,
					"numoutlets" : 3,
					"patching_rect" : [ 44.0, 447.0, 117.0, 18.0 ],
					"id" : "obj-1",
...
, 			{
				"box" : 				{
					...
					"hidden" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 44.0, 471.546204, 165.5, 18.0 ],
					"id" : "obj-10",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 4
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"patching_rect" : [ 397.0, 234.0, 144.0, 18.0 ],
					"id" : "obj-14",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 382.0, 339.0, 35.0, 18.0 ],
					"id" : "obj-7",
					"outlettype" : [ "int", "bang" ],
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"maximum" : 255,
					"bgcolor" : [ 0.866667, 0.866667, 0.866667, 1.0 ],
					"patching_rect" : [ 382.0, 292.0, 35.0, 18.0 ],
					"id" : "obj-8",
					"outlettype" : [ "int", "bang" ],
					"fontname" : "Arial",
					"htextcolor" : [ 0.870588, 0.870588, 0.870588, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"linecount" : 6,
					"numoutlets" : 0,
					"patching_rect" : [ 460.0, 295.0, 228.0, 75.0 ],
					"id" : "obj-11",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "range $1",
					"numoutlets" : 1,
					"patching_rect" : [ 382.0, 358.0, 55.0, 16.0 ],
					"id" : "obj-12",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"text" : "threshold $1",
					"numoutlets" : 1,
					"patching_rect" : [ 382.0, 311.0, 74.0, 16.0 ],
					"id" : "obj-13",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"text" : "cv.jit.canny",
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 394.0, 60.0, 18.0 ],
					"id" : "obj-6",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 50.0, 689.0, 111.0, 18.0 ],
					"id" : "obj-17",
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"linecount" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 646.5, 243.0, 38.0 ],
					"id" : "obj-18",
					"fontname" : "Arial",
					"fontsize" : 9.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"frgb" : [ 0.0, 0.0, 0.0, 0.901961 ],
					"patching_rect" : [ 185.0, 624.0, 105.0, 18.0 ],
					"id" : "obj-19",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"textcolor" : [ 0.0, 0.0, 0.0, 0.901961 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 622.0, 135.0, 20.0 ],
					"id" : "obj-22",
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "Output",
					"numoutlets" : 0,
					"patching_rect" : [ 55.5, 263.0, 44.0, 19.0 ],
					"id" : "obj-31",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"patching_rect" : [ 110.0, 235.0, 175.0, 19.0 ],
					"id" : "obj-37",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "Single-plane char",
					"numoutlets" : 0,
					"patching_rect" : [ 110.0, 263.0, 175.0, 19.0 ],
					"id" : "obj-38",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 50.0, 230.0, 55.0, 57.0 ],
					"border" : 1,
					"id" : "obj-39",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 50.0, 258.0, 240.0, 29.0 ],
					"border" : 1,
					"id" : "obj-42",
					"bordercolor" : [ 1.0, 1.0, 1.0, 0.647059 ],
					"rounded" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"bgcolor" : [ 0.615686, 0.607843, 0.607843, 0.2 ],
					"patching_rect" : [ 50.0, 230.0, 240.0, 29.0 ],
					"border" : 1,
					"id" : "obj-44",
					"bordercolor" : [ 1.0, 1.0, 1.0, 0.647059 ],
					"rounded" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 45.0, 617.0, 250.0, 95.0 ],
					"border" : 1,
					"id" : "obj-49",
...
, 			{
				"box" : 				{
					...
					"linecount" : 9,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 95.0, 243.0, 120.0 ],
					"id" : "obj-62",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 45.0, 90.0, 250.0, 130.0 ],
					"border" : 1,
					"id" : "obj-65",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"bgcolor" : [ 1.0, 1.0, 1.0, 0.403922 ],
					"patching_rect" : [ 45.0, 225.0, 250.0, 67.0 ],
					"border" : 1,
					"id" : "obj-5",
					"bordercolor" : [ 0.0, 0.0, 0.0, 0.517647 ],
					"rounded" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 315.0, 427.0, 338.0, 252.0 ],
					"border" : 1,
					"id" : "obj-147",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 314.0, 390.0, 83.0, 26.0 ],
					"border" : 1,
					"id" : "obj-9",
...
, 			{
				"box" : 				{
					"maxclass" : "jit.fpsgui",
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 683.0, 80.0, 36.0 ],
					"id" : "obj-70",
					"outlettype" : [ "", "" ],
					"fontname" : "Arial",
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 434.0, 320.0, 240.0 ],
					"id" : "obj-67",
					"outlettype" : [ "", "" ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 374.0, 285.0, 324.0, 99.0 ],
					"border" : 1,
					"id" : "obj-66",
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Identify edges in a greyscale image",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 313.0, 228.0, 244.0, 30.0 ],
					"border" : 1,
					"id" : "obj-141",
					"bordercolor" : [ 0.5, 0.5, 0.5, 0.5 ],
					"rounded" : 15,
