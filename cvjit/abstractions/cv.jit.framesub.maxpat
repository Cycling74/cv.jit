{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 264.0, 376.0, 455.0, 325.0 ],
		"bglocked" : 0,
		"defrect" : [ 264.0, 376.0, 455.0, 325.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 156.0, 129.0, 111.0, 18.0 ],
					"numinlets" : 1,
					"id" : "obj-17",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"linecount" : 3,
					"fontsize" : 9.0,
					"patching_rect" : [ 156.0, 86.5, 243.0, 38.0 ],
					"numinlets" : 1,
					"id" : "obj-18",
					"fontname" : "Arial",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"frgb" : [ 0.0, 0.0, 0.0, 0.901961 ],
					"patching_rect" : [ 291.0, 64.0, 105.0, 18.0 ],
					"numinlets" : 1,
					"id" : "obj-19",
					"fontname" : "Arial",
					"textcolor" : [ 0.0, 0.0, 0.0, 0.901961 ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"patching_rect" : [ 156.0, 62.0, 135.0, 20.0 ],
					"numinlets" : 1,
					"id" : "obj-22",
					"fontname" : "Arial",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"border" : 1,
					"patching_rect" : [ 151.0, 57.0, 250.0, 95.0 ],
					"numinlets" : 1,
					"id" : "obj-49",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"hidden" : 1,
					"patching_rect" : [ 172.0, 160.0, 102.0, 18.0 ],
					"numinlets" : 0,
					"id" : "obj-5",
					"fontname" : "Arial",
					"numoutlets" : 3,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"hidden" : 1,
					"patching_rect" : [ 172.0, 180.379517, 143.5, 18.0 ],
					"numinlets" : 4,
					"id" : "obj-10",
					"fontname" : "Arial",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"patching_rect" : [ 22.0, 105.0, 88.0, 17.0 ],
					"numinlets" : 2,
					"id" : "obj-2",
					"fontname" : "Arial",
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"text" : "t l l",
					"fontsize" : 9.0,
					"patching_rect" : [ 23.0, 61.0, 27.0, 17.0 ],
					"numinlets" : 1,
					"id" : "obj-3",
					"fontname" : "Arial",
					"numoutlets" : 2,
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-2", 1 ],
					"hidden" : 0,
					"midpoints" : [ 32.5, 88.0, 100.5, 88.0 ]
				}
