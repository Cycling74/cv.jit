{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 391.0, 44.0, 1029.0, 753.0 ],
		"bgcolor" : [ 0.941176, 0.921569, 0.882353, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 391.0, 44.0, 1029.0, 753.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "toggle",
					"numoutlets" : 1,
					"patching_rect" : [ 471.0, 344.0, 20.0, 20.0 ],
					"id" : "obj-33",
					"outlettype" : [ "int" ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"linecount" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 544.0, 349.0, 253.0, 41.0 ],
					"id" : "obj-14",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "precision $1",
					"numoutlets" : 1,
					"patching_rect" : [ 471.0, 368.0, 64.0, 16.0 ],
					"id" : "obj-23",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 544.0, 314.0, 224.0, 29.0 ],
					"id" : "obj-24",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 471.0, 261.0, 37.0, 18.0 ],
					"id" : "obj-25",
...
, 			{
				"box" : 				{
					...
					"maximum" : 255,
					"bgcolor" : [ 0.866667, 0.866667, 0.866667, 1.0 ],
					"patching_rect" : [ 471.0, 304.0, 35.0, 18.0 ],
					"id" : "obj-26",
					"outlettype" : [ "int", "bang" ],
					"fontname" : "Arial",
					"htextcolor" : [ 0.870588, 0.870588, 0.870588, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"linecount" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 545.0, 264.0, 236.0, 41.0 ],
					"id" : "obj-29",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "distance $1",
					"numoutlets" : 1,
					"patching_rect" : [ 471.0, 323.0, 62.0, 16.0 ],
					"id" : "obj-30",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"text" : "threshold $1",
					"numoutlets" : 1,
					"patching_rect" : [ 471.0, 279.0, 66.0, 16.0 ],
					"id" : "obj-32",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"text" : "prepend frgb",
					"numoutlets" : 1,
					"patching_rect" : [ 670.0, 522.0, 73.0, 18.0 ],
					"id" : "obj-27",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "swatch",
					"numoutlets" : 2,
					"patching_rect" : [ 670.0, 485.0, 128.0, 32.0 ],
					"id" : "obj-28",
					"outlettype" : [ "", "float" ],
					"compatibility" : 1,
					"numinlets" : 3
...
, 			{
				"box" : 				{
					...
					"linecount" : 6,
					"numoutlets" : 0,
					"patching_rect" : [ 669.0, 407.0, 163.0, 75.0 ],
					"id" : "obj-13",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 661.0, 402.0, 176.0, 143.0 ],
					"border" : 1,
					"id" : "obj-12",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"patching_rect" : [ 325.0, 378.0, 94.0, 18.0 ],
					"id" : "obj-11",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 337.0, 69.0, 18.0 ],
					"id" : "obj-8",
					"outlettype" : [ "jit_matrix", "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 317.0, 333.0, 89.0, 27.0 ],
					"border" : 1,
					"id" : "obj-9",
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Find salient points in an image",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"bgcolor" : [ 1.0, 1.0, 1.0, 0.396078 ],
					"patching_rect" : [ 466.0, 257.0, 338.0, 137.0 ],
					"border" : 1,
					"id" : "obj-66",
					"bordercolor" : [ 1.0, 0.0, 0.0, 0.647059 ],
					"rounded" : 0,
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 334.5, 261.0, 409.5, 261.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-11", 0 ],
					"hidden" : 1,
					"midpoints" : [ 679.5, 551.0, 657.0, 551.0, 657.0, 396.0, 431.0, 396.0, 431.0, 371.0, 334.5, 371.0 ]
				}
