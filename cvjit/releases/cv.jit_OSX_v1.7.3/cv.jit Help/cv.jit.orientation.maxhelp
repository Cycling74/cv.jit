{
	"patcher" : 	{
		...
		"bgcolor" : [ 0.941176, 0.921569, 0.886275, 1.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"linecount" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 379.0, 405.0, 68.0, 32.0 ],
					"id" : "obj-113",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 404.0, 47.0, 18.0 ],
					"id" : "obj-112",
...
, 			{
				"box" : 				{
					...
					"depthbuffer" : 0,
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 459.0, 100.0, 100.0 ],
					"id" : "obj-110",
					"outlettype" : [ "", "" ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"text" : "p draw",
					"numoutlets" : 1,
					"patching_rect" : [ 325.0, 428.0, 45.0, 18.0 ],
					"id" : "obj-109",
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 30.0, 89.0, 370.0, 306.0 ],
						"bglocked" : 0,
						"defrect" : [ 30.0, 89.0, 370.0, 306.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"patching_rect" : [ 50.0, 179.0, 111.0, 17.0 ],
									"id" : "obj-1",
									"outlettype" : [ "jit_matrix", "" ],
									"fontname" : "Arial",
									"fontsize" : 9.0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"patching_rect" : [ 50.0, 156.0, 225.0, 15.0 ],
									"id" : "obj-2",
									"outlettype" : [ "" ],
									"fontname" : "Arial",
									"fontsize" : 9.0,
...
, 							{
								"box" : 								{
									...
									"text" : "pack",
									"numoutlets" : 1,
									"patching_rect" : [ 50.0, 134.0, 47.0, 17.0 ],
									"id" : "obj-3",
									"outlettype" : [ "" ],
									"fontname" : "Arial",
									"fontsize" : 9.0,
...
, 							{
								"box" : 								{
									...
									"text" : "!- 100",
									"numoutlets" : 1,
									"patching_rect" : [ 87.0, 113.0, 39.0, 17.0 ],
									"id" : "obj-4",
									"outlettype" : [ "int" ],
									"fontname" : "Arial",
									"fontsize" : 9.0,
...
, 							{
								"box" : 								{
									...
									"text" : "!- 50",
									"numoutlets" : 1,
									"patching_rect" : [ 50.0, 113.0, 33.0, 17.0 ],
									"id" : "obj-5",
									"outlettype" : [ "int" ],
									"fontname" : "Arial",
									"fontsize" : 9.0,
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 87.0, 93.0, 35.0, 17.0 ],
									"id" : "obj-6",
									"outlettype" : [ "int", "bang" ],
									"fontname" : "Arial",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"bgcolor" : [ 0.866667, 0.866667, 0.866667, 1.0 ],
									"patching_rect" : [ 50.0, 93.0, 35.0, 17.0 ],
									"id" : "obj-7",
									"outlettype" : [ "int", "bang" ],
									"fontname" : "Arial",
									"htextcolor" : [ 0.870588, 0.870588, 0.870588, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"patching_rect" : [ 325.0, 377.0, 80.0, 18.0 ],
					"id" : "obj-108",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"patching_rect" : [ 403.0, 326.0, 134.0, 19.0 ],
					"id" : "obj-107",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "cv.jit.moments",
					"numoutlets" : 5,
					"patching_rect" : [ 325.0, 327.0, 74.0, 18.0 ],
					"id" : "obj-26",
					"outlettype" : [ "", "", "", "", "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 315.0, 223.0, 316.0, 134.0 ],
					"border" : 1,
					"id" : "obj-141",
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"varname" : "comments",
					"text" : "cv.jit.orientation calculates the orientation of a shape's main axis. You need to compute moments of inertia beforehand.\n\nThe orientation is calculated in radians, with 0 and Pi radians corresponding to a horizontal line. Pi/2 radians is vertical. Note that cv.jit.orientation only returns values between 0. and Pi.",
					"linecount" : 9,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "jit.fpsgui",
					"numoutlets" : 2,
					"patching_rect" : [ 464.0, 647.0, 80.0, 36.0 ],
					"id" : "obj-70",
					"outlettype" : [ "", "" ],
					"fontname" : "Arial",
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "jit.pwindow",
					"numoutlets" : 2,
					"patching_rect" : [ 464.0, 394.0, 320.0, 240.0 ],
					"id" : "obj-67",
					"outlettype" : [ "", "" ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Calculate the main axis of an image",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 456.0, 386.0, 336.0, 256.0 ],
					"border" : 1,
					"id" : "obj-147",
					"bordercolor" : [ 0.501961, 0.501961, 0.501961, 1.0 ],
					"rounded" : 15,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 316.0, 372.0, 98.0, 28.0 ],
					"border" : 1,
					"id" : "obj-9",
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 334.5, 311.0, 544.0, 311.0, 544.0, 373.0, 473.5, 373.0 ]
				}
