{
	"patcher" : 	{
		...
		"bgcolor" : [ 0.94902, 0.913725, 0.87451, 1.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"hidden" : 1,
					"numoutlets" : 3,
					"patching_rect" : [ 53.0, 492.0, 117.0, 18.0 ],
					"id" : "obj-1",
...
, 			{
				"box" : 				{
					...
					"hidden" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 53.0, 516.546204, 165.5, 18.0 ],
					"id" : "obj-10",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 4
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 339.0, 101.0, 18.0 ],
					"id" : "obj-29",
...
, 			{
				"box" : 				{
					...
					"text" : "prepend frgb",
					"numoutlets" : 1,
					"patching_rect" : [ 729.0, 392.0, 73.0, 18.0 ],
					"id" : "obj-27",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "swatch",
					"numoutlets" : 2,
					"patching_rect" : [ 729.0, 355.0, 128.0, 32.0 ],
					"id" : "obj-28",
					"outlettype" : [ "", "float" ],
					"compatibility" : 1,
					"numinlets" : 3
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Labeling must be done with char output and you must also compute blob moments.",
					"linecount" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 514.0, 316.0, 136.0, 41.0 ],
					"id" : "obj-25",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"linecount" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 491.0, 232.0, 150.0, 41.0 ],
					"id" : "obj-24",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"linecount" : 10,
					"numoutlets" : 0,
					"patching_rect" : [ 729.0, 229.0, 148.0, 121.0 ],
					"id" : "obj-13",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"patching_rect" : [ 325.0, 434.0, 396.0, 18.0 ],
					"id" : "obj-8",
					"outlettype" : [ "jit_matrix" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 388.0, 106.0, 18.0 ],
					"id" : "obj-7",
					"outlettype" : [ "jit_matrix", "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 316.0, 188.0, 18.0 ],
					"id" : "obj-6",
					"outlettype" : [ "jit_matrix", "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"text" : "Output",
					"numoutlets" : 0,
					"patching_rect" : [ 55.5, 314.0, 44.0, 19.0 ],
					"id" : "obj-31",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "Input",
					"numoutlets" : 0,
					"patching_rect" : [ 60.0, 286.0, 35.0, 19.0 ],
					"id" : "obj-34",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"patching_rect" : [ 110.0, 286.0, 175.0, 19.0 ],
					"id" : "obj-37",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"patching_rect" : [ 110.0, 314.0, 175.0, 19.0 ],
					"id" : "obj-38",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 50.0, 281.0, 55.0, 57.0 ],
					"border" : 1,
					"id" : "obj-39",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 50.0, 309.0, 240.0, 29.0 ],
					"border" : 1,
					"id" : "obj-42",
					"bordercolor" : [ 1.0, 1.0, 1.0, 0.647059 ],
					"rounded" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"bgcolor" : [ 0.615686, 0.607843, 0.607843, 0.2 ],
					"patching_rect" : [ 50.0, 281.0, 240.0, 29.0 ],
					"border" : 1,
					"id" : "obj-44",
					"bordercolor" : [ 1.0, 1.0, 1.0, 0.647059 ],
					"rounded" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"varname" : "comments",
					"text" : "cv.jit.blobs.elongation computes the elongation of each connected component found by cv.jit.label and analysed by cv.jit.blobs.moments.\nElongation is a measure of how thin a shape is. The closer elongation is to 0, the more compact the shape is, like a circle or square. The more line-like the shape becomes, the higher the elongation.\n\ncv.jit.blobs.elongation outputs a 1-plane single-row matrix whose number of cells is the same as the input matrix.",
					"linecount" : 13,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 95.0, 243.0, 171.0 ],
					"id" : "obj-62",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 45.0, 90.0, 250.0, 181.0 ],
					"border" : 1,
					"id" : "obj-65",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"bgcolor" : [ 1.0, 1.0, 1.0, 0.403922 ],
					"patching_rect" : [ 45.0, 276.0, 250.0, 67.0 ],
					"border" : 1,
					"id" : "obj-5",
					"bordercolor" : [ 0.0, 0.0, 0.0, 0.517647 ],
					"rounded" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 315.0, 384.0, 126.0, 28.0 ],
					"border" : 1,
					"id" : "obj-9",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 461.0, 320.0, 240.0 ],
					"id" : "obj-67",
					"outlettype" : [ "", "" ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 720.0, 222.0, 164.0, 196.0 ],
					"border" : 1,
					"id" : "obj-66",
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Find connected component elongations",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 315.0, 224.0, 329.0, 77.0 ],
					"border" : 1,
					"id" : "obj-141",
					"bordercolor" : [ 0.5, 0.5, 0.5, 0.5 ],
					"rounded" : 15,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 319.0, 456.0, 335.0, 257.0 ],
					"border" : 1,
					"id" : "obj-147",
					"bordercolor" : [ 0.5, 0.5, 0.5, 0.5 ],
					"rounded" : 15,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"bgcolor" : [ 0.776471, 0.776471, 0.776471, 0.0 ],
					"patching_rect" : [ 315.0, 311.0, 338.0, 52.0 ],
					"border" : 1,
					"id" : "obj-26",
					"bordercolor" : [ 0.5, 0.5, 0.5, 0.5 ],
					"rounded" : 15,
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-8", 2 ],
					"hidden" : 0,
					"midpoints" : [ 334.5, 305.0, 711.5, 305.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-8", 0 ],
					"hidden" : 0,
					"midpoints" : [ 738.5, 427.0, 334.5, 427.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-8", 1 ],
					"hidden" : 0,
					"midpoints" : [ 334.5, 376.0, 443.0, 376.0, 443.0, 422.0, 523.0, 422.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 420.5, 274.0, 334.5, 274.0 ]
				}
