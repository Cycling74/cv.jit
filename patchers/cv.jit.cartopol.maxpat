...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 264.0, 211.0, 121.0, 37.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 257.0, 204.0, 140.0, 65.0 ],
					"proportion" : 0.39,
					"rounded" : 0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 259.0, 209.0, 142.0, 64.0 ],
					"proportion" : 0.39,
					"rounded" : 0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 165.0, 172.0, 75.0, 19.0 ],
					"style" : "",
					"text" : "jit.op @op atan"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 165.0, 119.0, 65.0, 19.0 ],
					"style" : "",
					"text" : "jit.op @op !/"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 94.0, 119.0, 64.0, 19.0 ],
					"style" : "",
					"text" : "jit.op @op *"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 26.0, 172.0, 75.0, 19.0 ],
					"style" : "",
					"text" : "jit.op @op sqrt"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 26.0, 147.0, 63.0, 19.0 ],
					"style" : "",
					"text" : "jit.op @op +"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 26.0, 119.0, 64.0, 19.0 ],
					"style" : "",
					"text" : "jit.op @op *"
				}
