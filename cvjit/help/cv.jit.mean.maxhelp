{
	"patcher" : 	{
		...
		"bgcolor" : [ 0.941176, 0.937255, 0.890196, 1.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"linecount" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 450.0, 249.0, 134.0, 29.0 ],
					"id" : "obj-7",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"varname" : "comments",
					"text" : "Calculates the mean matrix value over time.\n\nNote that for integer (char/long) input, all internal processing is done using floating point data, so there should be no darkening of the image due to rounding.",
					"linecount" : 6,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"text" : "cv.jit.mean",
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 295.0, 58.0, 18.0 ],
					"id" : "obj-71",
...
, 			{
				"box" : 				{
					...
					"text" : "reset",
					"numoutlets" : 1,
					"patching_rect" : [ 411.0, 255.0, 33.0, 16.0 ],
					"id" : "obj-72",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Calculate the time-wise average matrix",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 401.0, 242.0, 188.0, 45.0 ],
					"border" : 1,
					"id" : "obj-66",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 317.0, 291.0, 78.0, 27.0 ],
					"border" : 1,
					"id" : "obj-9",
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-71", 0 ],
					"hidden" : 0,
					"midpoints" : [ 496.5, 232.0, 334.5, 232.0 ]
				}
