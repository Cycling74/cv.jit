...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 439.0, 336.0, 116.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 652.0, 28.0, 86.0, 20.0 ],
					"text" : "Or a video file"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 479.0, 28.0, 86.0, 20.0 ],
					"text" : "Use camera"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 805.0, 26.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 439.0, 295.0, 194.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 439.0, 374.0, 246.0, 22.0 ],
					"text" : "cv.jit.keypoints.draw @width 3 @normalize 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 835.0, 26.0, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 835.0, 132.0, 53.0, 22.0 ],
					"text" : "jit.matrix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 439.0, 254.5, 141.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 711.0, 66.0, 93.0, 22.0 ],
					"text" : "sel 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 748.0, 99.0, 31.0, 22.0 ],
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 711.0, 99.0, 32.0, 22.0 ],
					"text" : "start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 671.0, 75.0, 33.0, 22.0 ],
					"text" : "read"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 609.0, 22.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 609.0, 75.0, 56.0, 22.0 ],
					"text" : "qmetro 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 439.0, 194.0, 71.0, 22.0 ],
					"text" : "jit.rgb2luma"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 541.0, 75.0, 37.0, 22.0 ],
					"text" : "close"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 501.0, 75.0, 35.0, 22.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 439.0, 22.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 439.0, 75.0, 56.0, 22.0 ],
					"text" : "qmetro 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 609.0, 138.0, 161.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 439.0, 138.0, 153.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 135.0, 253.0, 251.0, 36.0 ],
					"text" : "This should be connected to the output of cv.jit.face.landmarks."
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Extract rigid points from face landmarks"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-34", 0 ],
					"midpoints" : [ 618.5, 170.0, 448.5, 170.0 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-34", 0 ],
					"midpoints" : [ 844.5, 170.0, 448.5, 170.0 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 448.5, 237.0, 675.5, 237.0 ],
					"order" : 0,
					"source" : [ "obj-34", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 448.5, 229.0, 623.5, 229.0 ],
					"order" : 1,
					"source" : [ "obj-34", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 720.5, 130.0, 618.5, 130.0 ],
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 618.5, 57.0, 720.5, 57.0 ],
					"order" : 0,
					"source" : [ "obj-40", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"hidden" : 1,
					"midpoints" : [ 757.5, 130.0, 618.5, 130.0 ],
					"source" : [ "obj-42", 0 ]
				}
