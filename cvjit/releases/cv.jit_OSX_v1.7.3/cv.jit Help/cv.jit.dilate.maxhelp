{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 281.0, 86.0, 1029.0, 753.0 ],
		"bgcolor" : [ 0.941176, 0.929412, 0.898039, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 281.0, 86.0, 1029.0, 753.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"patching_rect" : [ 447.0, 317.0, 178.0, 19.0 ],
					"id" : "obj-26",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "Output",
					"numoutlets" : 0,
					"patching_rect" : [ 55.5, 251.0, 44.0, 19.0 ],
					"id" : "obj-31",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "Any type,  single-plane matrices",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"text" : "Any type,  single-plane matrices",
					"numoutlets" : 0,
					"patching_rect" : [ 110.0, 251.0, 175.0, 19.0 ],
					"id" : "obj-38",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 50.0, 218.0, 55.0, 57.0 ],
					"border" : 1,
					"id" : "obj-39",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 50.0, 246.0, 240.0, 29.0 ],
					"border" : 1,
					"id" : "obj-42",
					"bordercolor" : [ 1.0, 1.0, 1.0, 0.647059 ],
					"rounded" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"varname" : "comments",
					"text" : "Performs binary or greyscale dilatation on the incoming matrix.\n\nBinary dilatation consists in marking a pixel ON if any of its neighbours is ON.\n\nGreyscale dilatation consists in giving each pixel the maximum value of the pixels around it.",
					"linecount" : 8,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"bgcolor" : [ 1.0, 1.0, 1.0, 0.403922 ],
					"patching_rect" : [ 45.0, 213.0, 250.0, 67.0 ],
					"border" : 1,
					"id" : "obj-5",
					"bordercolor" : [ 0.0, 0.0, 0.0, 0.517647 ],
					"rounded" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Morphological dilate operator",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"bgcolor" : [ 0.776471, 0.776471, 0.776471, 0.0 ],
					"patching_rect" : [ 409.0, 307.0, 227.0, 65.0 ],
					"border" : 1,
					"id" : "obj-27",
					"bordercolor" : [ 0.5, 0.5, 0.5, 0.5 ],
					"rounded" : 15,
