...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 81.5, 353.5, 98.0, 22.0 ],
					"text_width" : 59.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 70.0, 315.0, 128.0, 22.0 ],
					"text_width" : 77.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 185.0, 353.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 45.0, 66.0, 245.0, 218.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 63.0, 504.0, 42.0, 22.0 ],
					"style" : "default",
					"text" : "reset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 45.0, 536.0, 93.0, 22.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 843.0, 576.0, 118.0, 37.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 836.0, 569.0, 131.0, 54.0 ],
					"proportion" : 0.39,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 746.0, 462.5, 38.0, 22.0 ],
					"style" : "default",
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 786.0, 462.5, 140.0, 33.0 ],
					"style" : "default",
					"text" : "<- choose which blob to display based on size"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 525.0, 686.5, 125.0, 20.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 525.0, 701.5, 142.0, 20.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 525.0, 564.5, 160.0, 120.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 644.0, 486.0, 121.0, 22.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 644.0, 431.0, 195.0, 22.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 676.0, 287.0, 332.0, 127.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 241.0, 686.5, 52.0, 20.0 ],
					"style" : "default",
					"text" : "Mode 1:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 686.5, 52.0, 20.0 ],
					"style" : "default",
					"text" : "Mode 0:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 241.0, 701.5, 169.0, 20.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 701.5, 181.0, 20.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 45.0, 447.5, 34.0, 22.0 ],
					"style" : "default",
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 45.0, 471.5, 215.0, 22.0 ],
					"style" : "default",
					"text" : "gate 2 1"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 89.0, 108.0, 27.0, 0.0 ],
									"text" : "+ 1."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 4,
									"numoutlets" : 0,
									"patching_rect" : [ 130.0, 196.0, 104.0, 0.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 37.0, 153.0, 62.0, 0.0 ],
									"text" : "jit.op @op /"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 89.0, 77.0, 38.0, 0.0 ],
									"text" : "/ 255."
								}
...
,
					"patching_rect" : [ 241.0, 536.0, 90.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 320.0, 145.5, 342.0, 20.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 216.5, 384.5, 203.0, 33.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 45.0, 564.5, 160.0, 120.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 241.0, 564.5, 160.0, 120.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 312.333333333333314, 500.0, 48.0, 22.0 ],
					"style" : "default",
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 281.0, 471.5, 66.0, 22.0 ],
					"style" : "default",
					"text" : "jit.3m"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 320.0, 103.5, 342.0, 33.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 108.0, 500.0, 128.0, 33.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 202.0, 316.0, 393.0, 20.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 216.5, 351.5, 251.0, 33.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 795.0, 145.5, 214.0, 20.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 793.0, 106.5, 214.0, 33.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 746.0, 145.5, 52.0, 20.0 ],
					"style" : "default",
					"text" : "Output:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 746.0, 113.5, 43.0, 20.0 ],
					"style" : "default",
					"text" : "Input:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 742.0, 139.5, 51.0, 28.0 ],
					"proportion" : 0.39,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 742.0, 103.5, 51.0, 37.0 ],
					"proportion" : 0.39,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 742.0, 103.5, 266.0, 35.0 ],
					"proportion" : 0.39,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 742.0, 138.5, 266.0, 28.0 ],
					"proportion" : 0.39,
					"rounded" : 0
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 54.5, 298.0, 653.5, 298.0 ],
					"order" : 0,
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 194.5, 438.5, 54.5, 438.5 ],
					"order" : 1,
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 653.5, 519.0, 534.5, 519.0 ],
					"source" : [ "obj-34", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 54.5, 438.75, 250.5, 438.75 ],
					"order" : 1,
					"source" : [ "obj-57", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 54.5, 439.75, 290.5, 439.75 ],
					"order" : 0,
					"source" : [ "obj-57", 0 ]
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "cv.jit.label.maxhelp.maxsnap",
...
,
			"snapshotlist" : 			{
				...
				"entries" : [ 					{
						...
						"version" : 2,
						"minorversion" : 0,
						"name" : "cv.jit.label.maxhelp",
						"origin" : "cv.jit.label.maxhelp",
						"type" : "patcher",
						"subtype" : "Undefined",
						"embed" : 1,
						"snapshot" : 						{
...
,
						"fileref" : 						{
							"name" : "cv.jit.label.maxhelp",
							"filename" : "cv.jit.label.maxhelp.maxsnap",
							"filepath" : "~/Documents/Max 8/Snapshots",
							"filepos" : -1,
							"snapshotfileid" : "02a7f296f7b8c1e3f43dd4ee649e05c8"
						}
