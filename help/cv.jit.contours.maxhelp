...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 266.0, 574.0, 306.0, 34.0 ],
					"text" : "/angle : [-90., -7.94347]",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 291.0, 497.0, 100.0, 22.0 ],
					"style" : "",
					"text" : "o.select /angle"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 171.0, 75.0, 34.0, 22.0 ],
					"style" : "",
					"text" : "start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 117.0, 75.0, 33.0, 22.0 ],
					"style" : "",
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 123.0, 36.0, 46.0, 22.0 ],
					"style" : "",
					"text" : "sel 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 162.5, 118.0, 35.0, 22.0 ],
					"style" : "",
					"text" : "read"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 13.0, 150.0, 87.0, 49.0 ],
					"style" : "",
					"text" : "jit.movie @unique 1 @autostart 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 13.0, 20.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 13.0, 53.0, 65.0, 22.0 ],
					"style" : "",
					"text" : "qmetro 20"
				}
...
,
					"patching_rect" : [ 292.0, 428.0, 99.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 454.0, 95.0, 150.0, 47.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 543.0, 286.0, 150.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 543.0, 234.0, 150.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 301.0, 115.0, 39.0, 22.0 ],
					"style" : "",
					"text" : "close"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 239.0, 115.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 210.0, 154.0, 108.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 316.0, 218.0, 195.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 543.0, 260.0, 150.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 77.0, 260.0, 80.0, 35.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 77.0, 548.0, 103.0, 62.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 77.0, 518.0, 105.0, 22.0 ],
					"style" : "",
					"text_width" : 66.0
				}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"style" : "",
													"text" : "color 1. 1. 1. 1., moveto $2 $3 0, circle 0.02"
												}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 3,
																	"outlettype" : [ "", "", "" ],
																	"patching_rect" : [ 50.0, 94.0, 245.0, 22.0 ],
																	"style" : "",
																	"text" : "dict.unpack /centroid/x: /aspect: /centroid/y:"
																}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 260.0, 203.0, 132.0, 49.0 ],
													"style" : "",
													"text" : "color 1. 1. 1. 1., position $2 $3 0, text $1, bang"
												}
...
,
														...
														"boxes" : [ 															{
																"box" : 																{
																	...
																	"style" : "",
																	"text" : "moveto $1 $2 0., glcolor 0.5 1 0. 0.5, lineto $3 $4 0., glcolor 0.5 0 1. 15, circle 0.03, glcolor 0.5 1 0. 0.5, lineto $5 $6 0."
																}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 577.833313, 231.0, 207.0, 35.0 ],
									"style" : "",
									"text" : "linesegment $1 $2 0 $3 $4 0, linesegment $1 $2 0 $5 $5 0"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "dictionary" ],
													"patching_rect" : [ 50.0, 218.5, 51.0, 22.0 ],
													"style" : "",
													"text" : "dict.join"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "dictionary" ],
													"patching_rect" : [ 82.0, 189.0, 103.0, 22.0 ],
													"style" : "",
													"text" : "dict.pack /aspect:"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 82.0, 158.0, 29.5, 22.0 ],
													"style" : "",
													"text" : "/ 1."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 82.0, 130.0, 119.0, 22.0 ],
													"style" : "",
													"text" : "dict.unpack /dim_xy:"
												}
...
,
									"patching_rect" : [ 108.333313, 208.0, 77.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "jit_matrix" ],
									"patching_rect" : [ 625.0, 58.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 625.0, 117.5, 169.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 108.333313, 343.5, 140.0, 62.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 108.333313, 253.5, 67.0, 22.0 ],
									"style" : "",
									"text" : "t b l erase"
								}
...
,
					"patching_rect" : [ 210.0, 594.0, 47.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 210.0, 80.0, 65.0, 22.0 ],
					"style" : "",
					"text" : "qmetro 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 262.5, 364.0, 127.0, 35.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 387.0, 260.0, 150.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 387.0, 286.0, 150.0, 22.0 ],
					"style" : ""
				}
