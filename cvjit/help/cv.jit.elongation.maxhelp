{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 411.0, 44.0, 1029.0, 753.0 ],
		"bgcolor" : [ 0.945098, 0.92549, 0.87451, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 411.0, 44.0, 1029.0, 753.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"patching_rect" : [ 747.0, 325.0, 164.0, 18.0 ],
					"id" : "obj-13",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "Elongation",
					"numoutlets" : 0,
					"patching_rect" : [ 715.0, 392.0, 118.0, 18.0 ],
					"id" : "obj-11",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 670.0, 393.0, 37.0, 18.0 ],
					"id" : "obj-12",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"patching_rect" : [ 670.0, 361.0, 79.0, 18.0 ],
					"id" : "obj-3",
					"outlettype" : [ "float" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"text" : "cv.jit.moments",
					"numoutlets" : 5,
					"patching_rect" : [ 670.0, 324.0, 74.0, 18.0 ],
					"id" : "obj-1",
					"outlettype" : [ "", "", "", "", "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"varname" : "comments",
					"text" : "cv.jit.elongation receives moments of inertia calculated by cv.jit.moments and computes the elongation of the shape. Elongation quantifies how thin a shape is. \nHigh values correspond to thin shapes, like lines, where pixels are grouped close to the main axis (as cv.jit.orientation calculates). On the other hand, the closer elongation is to 0, the more the shape is spread out, like a circle.",
					"linecount" : 9,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 95.0, 240.0, 120.0 ],
					"id" : "obj-62",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 660.0, 356.0, 96.0, 27.0 ],
					"border" : 1,
					"id" : "obj-9",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 664.0, 318.0, 261.0, 30.0 ],
					"border" : 1,
					"id" : "obj-66",
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Calculate the thinness of an image",
					"numoutlets" : 0,
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-1", 0 ],
					"hidden" : 0,
					"midpoints" : [ 334.5, 314.0, 679.5, 314.0 ]
				}
