{
	"patcher" : 	{
		...
		"bgcolor" : [ 0.945098, 0.905882, 0.866667, 1.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"patching_rect" : [ 443.0, 317.0, 178.0, 19.0 ],
					"id" : "obj-26",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "cv.jit.erode",
					"numoutlets" : 2,
					"patching_rect" : [ 664.0, 365.0, 59.0, 18.0 ],
					"id" : "obj-12",
...
, 			{
				"box" : 				{
					...
					"text" : "cv.jit.erode",
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 365.0, 59.0, 18.0 ],
					"id" : "obj-4",
					"outlettype" : [ "jit_matrix", "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"varname" : "comments",
					"text" : "Performs binary or greyscale erosion on the incoming matrix.\n\nBinary erosion consists in marking a pixel ON only if all of its neighbours are also ON.\n\nGreyscale erosion consists in giving each pixel the minimum value of the pixels around it.",
					"linecount" : 8,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 95.0, 240.0, 108.0 ],
					"id" : "obj-62",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Morphological erode operator",
					"numoutlets" : 0,
