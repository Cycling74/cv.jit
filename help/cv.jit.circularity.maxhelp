...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "" ],
					"patching_rect" : [ 33.0, 403.0, 86.0, 22.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 658.0, 309.0, 163.0, 17.0 ],
					"text" : "Float"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 656.0, 274.0, 163.0, 17.0 ],
					"text" : "List"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 610.0, 309.0, 185.0, 17.0 ],
					"text" : "Output:",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 610.0, 274.0, 185.0, 17.0 ],
					"text" : "Input:",
					"textcolor" : [ 0.968627, 0.968627, 0.968627, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 606.0, 267.0, 51.0, 37.0 ],
					"proportion" : 0.39,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 606.0, 267.0, 218.0, 36.0 ],
					"proportion" : 0.39,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 472.0, 97.0, 389.0, 154.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 20.0, 396.0, 116.0, 34.0 ],
					"proportion" : 0.39,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 606.0, 301.0, 51.0, 37.0 ],
					"proportion" : 0.39,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 606.0, 302.0, 218.0, 36.0 ],
					"proportion" : 0.39,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 609.0, 270.0, 218.0, 72.0 ],
					"proportion" : 0.39,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 463.0, 92.0, 418.0, 163.0 ],
					"proportion" : 0.39,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 467.0, 97.0, 418.0, 163.0 ],
					"proportion" : 0.39,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 714.0, 212.0, 4.0, 98.0 ],
					"proportion" : 0.39,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 705.0, 212.0, 4.0, 98.0 ],
					"proportion" : 0.39,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 696.0, 212.0, 4.0, 98.0 ],
					"proportion" : 0.39,
					"rounded" : 0
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "cv.jit.circularity.maxhelp.maxsnap",
...
,
			"snapshotlist" : 			{
				...
				"entries" : [ 					{
						...
						"version" : 2,
						"minorversion" : 0,
						"name" : "cv.jit.circularity.maxhelp",
						"origin" : "cv.jit.circularity.maxhelp",
						"type" : "patcher",
						"subtype" : "Undefined",
						"embed" : 1,
						"snapshot" : 						{
...
,
						"fileref" : 						{
							"name" : "cv.jit.circularity.maxhelp",
							"filename" : "cv.jit.circularity.maxhelp.maxsnap",
							"filepath" : "~/Documents/Max 8/Snapshots",
							"filepos" : -1,
							"snapshotfileid" : "aedb0adaa41d214f233457ef65cef1b7"
						}
