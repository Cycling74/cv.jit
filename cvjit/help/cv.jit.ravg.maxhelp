{
	"patcher" : 	{
		...
		"bgcolor" : [ 0.94902, 0.917647, 0.890196, 1.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"maximum" : 1.0,
					"patching_rect" : [ 525.0, 230.0, 47.0, 18.0 ],
					"id" : "obj-120",
...
, 			{
				"box" : 				{
					...
					"text" : "alpha $1",
					"numoutlets" : 1,
					"patching_rect" : [ 525.0, 252.0, 49.0, 16.0 ],
					"id" : "obj-118",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"linecount" : 4,
					"numoutlets" : 0,
					"patching_rect" : [ 577.0, 230.0, 237.0, 57.0 ],
					"id" : "obj-7",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 511.0, 224.0, 325.0, 76.0 ],
					"border" : 1,
					"id" : "obj-66",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 289.0, 107.0, 18.0 ],
					"id" : "obj-108",
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"varname" : "comments",
					"text" : "The running average is a smoothing function where the output is the average of previous inputs. In this sense, cv.jit.ravg is similar to cv.jit.mean. However, in the case of cv.jit.ravg, the output can be thought of as representing the mean value of recent pixel values. \nThe running average is useful in tasks such as background subtraction and data smoothing. \n\nThe formula used to calculate pixel values is: \nrunning average = alpha * new frame + (1 - alpha) * previous average\n\njit.slide performs a similar task but cv.jit.ravg does all its calculations in floating point, yielding much fewer artifacts.",
					"linecount" : 16,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "jit.fpsgui",
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 584.0, 80.0, 36.0 ],
					"id" : "obj-70",
					"outlettype" : [ "", "" ],
					"fontname" : "Arial",
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 331.0, 320.0, 240.0 ],
					"id" : "obj-67",
					"outlettype" : [ "", "" ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 317.0, 323.0, 336.0, 256.0 ],
					"border" : 1,
					"id" : "obj-147",
					"bordercolor" : [ 0.501961, 0.501961, 0.501961, 1.0 ],
					"rounded" : 15,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 314.0, 285.0, 130.0, 26.0 ],
					"border" : 1,
					"id" : "obj-9",
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 534.5, 276.0, 334.5, 276.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-108", 0 ],
					"hidden" : 0,
					"midpoints" : [ 496.5, 231.0, 334.5, 231.0 ]
				}
