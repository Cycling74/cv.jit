...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 418.0, 489.5, 80.0, 35.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 67.0, 69.0, 245.0, 218.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 562.0, 532.0, 118.0, 37.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 555.0, 525.0, 138.0, 55.0 ],
					"proportion" : 0.39,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 67.0, 533.0, 333.5, 47.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 208.0, 496.0, 137.0, 22.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 473.0, 206.0, 214.0, 20.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 503.0, 336.0, 77.0, 20.0 ],
					"style" : "default",
					"text" : "Isolated blob"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 418.0, 358.0, 160.0, 120.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 471.0, 168.0, 214.0, 33.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 420.0, 106.0, 243.0, 33.0 ],
					"style" : "default",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 148.0, 346.0, 79.0, 20.0 ],
					"style" : "default",
					"text" : "Binary image"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 424.0, 206.0, 52.0, 20.0 ],
					"style" : "default",
					"text" : "Output:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 424.0, 172.0, 43.0, 20.0 ],
					"style" : "default",
					"text" : "Input:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 420.0, 165.0, 273.0, 36.0 ],
					"proportion" : 0.39,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 420.0, 200.0, 273.0, 29.0 ],
					"proportion" : 0.39,
					"rounded" : 0
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 76.5, 298.5, 427.5, 298.5 ],
					"order" : 0,
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-31", 0 ],
					"midpoints" : [ 217.5, 527.0, 370.0, 527.0, 370.0, 298.0, 427.5, 298.0 ],
					"source" : [ "obj-26", 0 ]
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "cv.jit.floodfill.maxhelp.maxsnap",
...
,
			"snapshotlist" : 			{
				...
				"entries" : [ 					{
						...
						"version" : 2,
						"minorversion" : 0,
						"name" : "cv.jit.floodfill.maxhelp",
						"origin" : "cv.jit.floodfill.maxhelp",
						"type" : "patcher",
						"subtype" : "Undefined",
						"embed" : 1,
						"snapshot" : 						{
...
,
						"fileref" : 						{
							"name" : "cv.jit.floodfill.maxhelp",
							"filename" : "cv.jit.floodfill.maxhelp.maxsnap",
							"filepath" : "~/Documents/Max 8/Snapshots",
							"filepos" : -1,
							"snapshotfileid" : "cdd8e2d8274de9a49e971c1ebb057d08"
						}
