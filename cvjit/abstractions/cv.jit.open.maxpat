{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 124.0, 141.0, 578.0, 399.0 ],
		"bglocked" : 0,
		"defrect" : [ 124.0, 141.0, 578.0, 399.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 288.0, 219.0, 111.0, 18.0 ],
					"numinlets" : 1,
					"id" : "obj-17",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"linecount" : 3,
					"fontsize" : 9.0,
					"patching_rect" : [ 288.0, 176.5, 243.0, 38.0 ],
					"numinlets" : 1,
					"id" : "obj-18",
					"fontname" : "Arial",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"frgb" : [ 0.0, 0.0, 0.0, 0.901961 ],
					"patching_rect" : [ 423.0, 154.0, 105.0, 18.0 ],
					"numinlets" : 1,
					"id" : "obj-19",
					"fontname" : "Arial",
					"textcolor" : [ 0.0, 0.0, 0.0, 0.901961 ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"patching_rect" : [ 288.0, 152.0, 135.0, 20.0 ],
					"numinlets" : 1,
					"id" : "obj-22",
					"fontname" : "Arial",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"border" : 1,
					"patching_rect" : [ 283.0, 147.0, 250.0, 95.0 ],
					"numinlets" : 1,
					"id" : "obj-49",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"hidden" : 1,
					"patching_rect" : [ 304.0, 250.0, 102.0, 18.0 ],
					"numinlets" : 0,
					"id" : "obj-5",
					"fontname" : "Arial",
					"numoutlets" : 3,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"hidden" : 1,
					"patching_rect" : [ 304.0, 270.379517, 143.5, 18.0 ],
					"numinlets" : 4,
					"id" : "obj-15",
					"fontname" : "Arial",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"text" : "loadbang",
					"fontsize" : 9.0,
					"patching_rect" : [ 211.0, 35.0, 46.0, 17.0 ],
					"numinlets" : 1,
					"id" : "obj-6",
					"fontname" : "Arial",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "patcherargs",
					"fontsize" : 9.0,
					"patching_rect" : [ 211.0, 58.0, 62.0, 17.0 ],
					"numinlets" : 1,
					"id" : "obj-7",
					"fontname" : "Arial",
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"text" : "greyscale $1",
					"fontsize" : 9.0,
					"patching_rect" : [ 83.0, 127.0, 65.0, 15.0 ],
					"numinlets" : 2,
					"id" : "obj-8",
					"fontname" : "Arial",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "mode $1",
					"fontsize" : 9.0,
					"patching_rect" : [ 36.0, 127.0, 45.0, 15.0 ],
					"numinlets" : 2,
					"id" : "obj-9",
					"fontname" : "Arial",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"patching_rect" : [ 36.0, 96.0, 201.0, 17.0 ],
					"numinlets" : 1,
					"id" : "obj-10",
					"fontname" : "Arial",
					"numoutlets" : 5,
...
, 			{
				"box" : 				{
					"maxclass" : "outlet",
					"patching_rect" : [ 177.0, 279.0, 15.0, 15.0 ],
					"numinlets" : 1,
					"id" : "obj-11",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"text" : "cv.jit.erode",
					"fontsize" : 9.0,
					"patching_rect" : [ 177.0, 209.0, 61.0, 17.0 ],
					"numinlets" : 1,
					"id" : "obj-13",
					"fontname" : "Arial",
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"text" : "cv.jit.dilate",
					"fontsize" : 9.0,
					"patching_rect" : [ 177.0, 237.0, 61.0, 17.0 ],
					"numinlets" : 1,
					"id" : "obj-14",
					"fontname" : "Arial",
					"numoutlets" : 2,
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-14", 0 ],
					"hidden" : 0,
					"midpoints" : [ 45.5, 231.0, 186.5, 231.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-14", 0 ],
					"hidden" : 0,
					"midpoints" : [ 92.5, 231.0, 186.5, 231.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 92.5, 175.0, 186.5, 175.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-13", 0 ],
					"hidden" : 0,
					"midpoints" : [ 45.5, 175.0, 186.5, 175.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-13", 0 ],
					"hidden" : 0,
					"midpoints" : [ 227.5, 158.0, 186.5, 158.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-8", 0 ],
					"hidden" : 0,
					"midpoints" : [ 136.5, 118.0, 92.5, 118.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-10", 0 ],
					"hidden" : 0,
					"midpoints" : [ 263.5, 89.0, 45.5, 89.0 ]
				}
