{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 361.0, 296.0, 326.0, 364.0 ],
		"bgcolor" : [ 0.882353, 0.862745, 0.815686, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 361.0, 296.0, 326.0, 364.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 23.0, 277.0, 111.0, 18.0 ],
					"numinlets" : 1,
					"id" : "obj-17",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"linecount" : 3,
					"fontsize" : 9.0,
					"patching_rect" : [ 23.0, 234.5, 243.0, 38.0 ],
					"numinlets" : 1,
					"id" : "obj-18",
					"fontname" : "Arial",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"frgb" : [ 0.0, 0.0, 0.0, 0.901961 ],
					"patching_rect" : [ 158.0, 212.0, 105.0, 18.0 ],
					"numinlets" : 1,
					"id" : "obj-19",
					"fontname" : "Arial",
					"textcolor" : [ 0.0, 0.0, 0.0, 0.901961 ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"patching_rect" : [ 23.0, 210.0, 135.0, 20.0 ],
					"numinlets" : 1,
					"id" : "obj-22",
					"fontname" : "Arial",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"border" : 1,
					"patching_rect" : [ 18.0, 205.0, 250.0, 95.0 ],
					"numinlets" : 1,
					"id" : "obj-49",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"hidden" : 1,
					"patching_rect" : [ 39.0, 308.0, 102.0, 18.0 ],
					"numinlets" : 0,
					"id" : "obj-40",
					"fontname" : "Arial",
					"numoutlets" : 3,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"hidden" : 1,
					"patching_rect" : [ 39.0, 328.379517, 143.5, 18.0 ],
					"numinlets" : 4,
					"id" : "obj-10",
					"fontname" : "Arial",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"text" : "route done",
					"fontsize" : 10.0,
					"patching_rect" : [ 201.0, 64.0, 58.0, 18.0 ],
					"numinlets" : 1,
					"id" : "obj-2",
					"fontname" : "Arial",
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"text" : "prepend dim",
					"fontsize" : 10.0,
					"patching_rect" : [ 121.0, 64.0, 66.0, 18.0 ],
					"numinlets" : 1,
					"id" : "obj-8",
					"fontname" : "Arial",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "loadbang",
					"fontsize" : 10.0,
					"patching_rect" : [ 121.0, 22.0, 52.0, 18.0 ],
					"numinlets" : 1,
					"id" : "obj-7",
					"fontname" : "Arial",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "patcherargs",
					"fontsize" : 10.0,
					"patching_rect" : [ 121.0, 43.0, 99.0, 18.0 ],
					"numinlets" : 1,
					"id" : "obj-6",
					"fontname" : "Arial",
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"patching_rect" : [ 34.0, 103.0, 154.0, 18.0 ],
					"numinlets" : 1,
					"id" : "obj-5",
					"fontname" : "Arial",
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "outlet",
					"patching_rect" : [ 34.0, 161.0, 25.0, 25.0 ],
					"numinlets" : 1,
					"id" : "obj-3",
					"numoutlets" : 0,
					"comment" : "(Matrix) out"
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-5", 0 ],
					"hidden" : 0,
					"midpoints" : [ 130.5, 88.0, 43.5, 88.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-5", 0 ],
					"hidden" : 0,
					"midpoints" : [ 249.5, 94.0, 43.5, 94.0 ]
				}
