{
	"patcher" : 	{
		...
		"bgcolor" : [ 0.941176, 0.929412, 0.886275, 1.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"hidden" : 1,
					"numoutlets" : 3,
					"patching_rect" : [ 34.0, 487.0, 117.0, 18.0 ],
					"id" : "obj-1",
...
, 			{
				"box" : 				{
					...
					"hidden" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 34.0, 511.546204, 165.5, 18.0 ],
					"id" : "obj-10",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 4
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 471.0, 365.0, 235.0, 63.0 ],
					"border" : 1,
					"id" : "obj-41",
...
, 			{
				"box" : 				{
					...
					"linecount" : 4,
					"numoutlets" : 0,
					"patching_rect" : [ 522.0, 371.0, 188.0, 52.0 ],
					"id" : "obj-36",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					"maxclass" : "toggle",
					"numoutlets" : 1,
					"patching_rect" : [ 481.0, 371.0, 20.0, 20.0 ],
					"id" : "obj-35",
					"outlettype" : [ "int" ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"text" : "prepend frgb",
					"numoutlets" : 1,
					"patching_rect" : [ 729.0, 379.0, 73.0, 18.0 ],
					"id" : "obj-27",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "swatch",
					"numoutlets" : 2,
					"patching_rect" : [ 729.0, 342.0, 128.0, 32.0 ],
					"id" : "obj-28",
					"outlettype" : [ "", "float" ],
					"compatibility" : 1,
					"numinlets" : 3
...
, 			{
				"box" : 				{
					...
					"linecount" : 9,
					"numoutlets" : 0,
					"patching_rect" : [ 728.0, 227.0, 159.0, 110.0 ],
					"id" : "obj-13",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 388.0, 98.0, 18.0 ],
					"id" : "obj-7",
					"outlettype" : [ "jit_matrix", "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"linecount" : 13,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 95.0, 246.0, 171.0 ],
					"id" : "obj-62",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 315.0, 384.0, 117.0, 26.0 ],
					"border" : 1,
					"id" : "obj-9",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 720.0, 222.0, 175.0, 182.0 ],
					"border" : 1,
					"id" : "obj-66",
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Find connected component directions",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"text" : "flip $1",
					"numoutlets" : 1,
					"patching_rect" : [ 481.0, 392.0, 37.0, 16.0 ],
					"id" : "obj-32",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-7", 0 ],
					"hidden" : 0,
					"midpoints" : [ 490.5, 412.0, 449.0, 412.0, 449.0, 364.0, 334.5, 364.0 ]
				}
