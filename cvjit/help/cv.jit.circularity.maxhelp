{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 167.0, 65.0, 1029.0, 753.0 ],
		"bgcolor" : [ 0.941176, 0.917647, 0.882353, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 167.0, 65.0, 1029.0, 753.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "Circularity",
					"numoutlets" : 0,
					"patching_rect" : [ 750.0, 435.0, 55.0, 18.0 ],
					"id" : "obj-27",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "Perimeter",
					"numoutlets" : 0,
					"patching_rect" : [ 807.0, 404.0, 54.0, 18.0 ],
					"id" : "obj-26",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					"maxclass" : "number",
					"numoutlets" : 2,
					"patching_rect" : [ 756.0, 404.0, 48.0, 18.0 ],
					"id" : "obj-23",
					"outlettype" : [ "int", "bang" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"numoutlets" : 2,
					"patching_rect" : [ 699.0, 435.0, 48.0, 18.0 ],
					"id" : "obj-13",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"patching_rect" : [ 699.0, 374.0, 76.0, 18.0 ],
					"id" : "obj-4",
					"outlettype" : [ "float", "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"linecount" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 492.0, 253.0, 127.0, 41.0 ],
					"id" : "obj-3",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"hidden" : 1,
					"numoutlets" : 3,
					"patching_rect" : [ 74.0, 503.0, 117.0, 18.0 ],
					"id" : "obj-6",
...
, 			{
				"box" : 				{
					...
					"hidden" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 74.0, 527.546204, 165.5, 18.0 ],
					"id" : "obj-10",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 4
...
, 			{
				"box" : 				{
					...
					"text" : "Output",
					"numoutlets" : 0,
					"patching_rect" : [ 55.5, 327.0, 44.0, 19.0 ],
					"id" : "obj-31",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "Float (left) and int (right)",
					"numoutlets" : 0,
					"patching_rect" : [ 110.0, 327.0, 175.0, 19.0 ],
					"id" : "obj-38",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 50.0, 294.0, 55.0, 57.0 ],
					"border" : 1,
					"id" : "obj-39",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 50.0, 322.0, 240.0, 29.0 ],
					"border" : 1,
					"id" : "obj-42",
					"bordercolor" : [ 1.0, 1.0, 1.0, 0.647059 ],
					"rounded" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"varname" : "comments",
					"text" : "cv.jit.circularity computes how compact a shape is. That is to say, circularity is defined as a ration between a shape's area and its perimeter. Theoretically, the most compact shape is the circle. In digital images, however, due to aliasing, shapes such as squares may seem more compact.\n\nThe higher the circularity, the more compact a shape is, with a perfect circle returning 1. The closer to 0 circularity is, the more jagged is the shape's outline.\n\ncv.jit.circularity also returns the perimeter.",
					"linecount" : 14,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 95.0, 241.0, 184.0 ],
					"id" : "obj-62",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"bgcolor" : [ 1.0, 1.0, 1.0, 0.403922 ],
					"patching_rect" : [ 45.0, 289.0, 250.0, 67.0 ],
					"border" : 1,
					"id" : "obj-5",
					"bordercolor" : [ 0.0, 0.0, 0.0, 0.517647 ],
					"rounded" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"numoutlets" : 2,
					"patching_rect" : [ 411.0, 253.0, 48.0, 18.0 ],
					"id" : "obj-74",
					"outlettype" : [ "float", "bang" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 304.0, 243.0, 18.0 ],
					"id" : "obj-71",
...
, 			{
				"box" : 				{
					...
					"text" : "jit.rgb2luma",
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 252.0, 62.0, 18.0 ],
					"id" : "obj-69",
					"outlettype" : [ "jit_matrix", "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 390.0, 320.0, 240.0 ],
					"id" : "obj-67",
					"outlettype" : [ "", "" ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"text" : "threshold $1",
					"numoutlets" : 1,
					"patching_rect" : [ 411.0, 275.0, 64.0, 16.0 ],
					"id" : "obj-72",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Calculate the compactness of a shape",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 318.0, 382.0, 334.0, 255.0 ],
					"border" : 1,
					"id" : "obj-147",
					"bordercolor" : [ 0.5, 0.5, 0.5, 0.5 ],
					"rounded" : 15,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 316.0, 245.0, 312.0, 91.0 ],
					"border" : 1,
					"id" : "obj-141",
					"bordercolor" : [ 0.5, 0.5, 0.5, 0.5 ],
					"rounded" : 15,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 688.0, 370.0, 102.0, 27.0 ],
					"border" : 1,
					"id" : "obj-9",
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-71", 0 ],
					"hidden" : 0,
					"midpoints" : [ 420.5, 297.0, 334.5, 297.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-4", 0 ],
					"hidden" : 0,
					"midpoints" : [ 334.5, 347.0, 708.5, 347.0 ]
				}
