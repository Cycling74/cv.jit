	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"hidden" : 1,
					"numoutlets" : 3,
					"patching_rect" : [ 71.0, 497.0, 117.0, 18.0 ],
					"id" : "obj-1",
...
, 			{
				"box" : 				{
					...
					"hidden" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 71.0, 521.546204, 165.5, 18.0 ],
					"id" : "obj-10",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 4
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 554.0, 128.0, 77.0, 16.0 ],
					"id" : "obj-30",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 529.0, 326.0, 112.0, 29.0 ],
					"id" : "obj-25",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 315.0, 322.0, 337.0, 38.0 ],
					"border" : 1,
					"id" : "obj-26",
...
, 			{
				"box" : 				{
					...
					"text" : "prepend frgb",
					"numoutlets" : 1,
					"patching_rect" : [ 672.0, 341.0, 73.0, 18.0 ],
					"id" : "obj-11",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "swatch",
					"numoutlets" : 2,
					"patching_rect" : [ 672.0, 304.0, 128.0, 32.0 ],
					"id" : "obj-12",
					"outlettype" : [ "", "float" ],
					"compatibility" : 1,
					"numinlets" : 3
...
, 			{
				"box" : 				{
					...
					"linecount" : 5,
					"numoutlets" : 0,
					"patching_rect" : [ 670.0, 234.0, 188.0, 64.0 ],
					"id" : "obj-13",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"patching_rect" : [ 325.0, 410.0, 207.0, 18.0 ],
					"id" : "obj-8",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 374.0, 93.0, 18.0 ],
					"id" : "obj-7",
					"outlettype" : [ "jit_matrix", "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 332.0, 188.0, 18.0 ],
					"id" : "obj-6",
					"outlettype" : [ "jit_matrix", "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 50.0, 712.0, 111.0, 18.0 ],
					"id" : "obj-17",
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"linecount" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 669.5, 243.0, 38.0 ],
					"id" : "obj-18",
					"fontname" : "Arial",
					"fontsize" : 9.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"frgb" : [ 0.0, 0.0, 0.0, 0.901961 ],
					"patching_rect" : [ 185.0, 647.0, 105.0, 18.0 ],
					"id" : "obj-19",
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"textcolor" : [ 0.0, 0.0, 0.0, 0.901961 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 645.0, 135.0, 20.0 ],
					"id" : "obj-22",
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "Output",
					"numoutlets" : 0,
					"patching_rect" : [ 55.5, 276.5, 44.0, 19.0 ],
					"id" : "obj-31",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "Input",
					"numoutlets" : 0,
					"patching_rect" : [ 60.0, 223.0, 35.0, 19.0 ],
					"id" : "obj-34",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"patching_rect" : [ 110.0, 223.0, 175.0, 19.0 ],
					"id" : "obj-37",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "4-plane single-row float32\nPlane 1: left coordinate\nPlane 2: top coordinate\nPlane 3: right coordinate\nPlane 4: Bottom coordinate",
					"linecount" : 5,
					"numoutlets" : 0,
					"patching_rect" : [ 110.0, 251.0, 175.0, 70.0 ],
					"id" : "obj-38",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 50.0, 218.0, 55.0, 108.0 ],
					"border" : 1,
					"id" : "obj-39",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 50.0, 246.0, 240.0, 80.0 ],
					"border" : 1,
					"id" : "obj-42",
					"bordercolor" : [ 1.0, 1.0, 1.0, 0.647059 ],
					"rounded" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"bgcolor" : [ 0.615686, 0.607843, 0.607843, 0.2 ],
					"patching_rect" : [ 50.0, 218.0, 240.0, 29.0 ],
					"border" : 1,
					"id" : "obj-44",
					"bordercolor" : [ 1.0, 1.0, 1.0, 0.647059 ],
					"rounded" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 45.0, 640.0, 250.0, 95.0 ],
					"border" : 1,
					"id" : "obj-49",
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"varname" : "comments",
					"text" : "cv.jit.blobs.bounds offers similar functionality to jit.findbounds but finds the bounding box for every blob in a labeled image.\n\ncv.jit.blobs.bounds outputs a 4-plane 1-dimension float32 matrix whose number of cells is the same as the number of blobs in the input image. ",
					"linecount" : 8,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 95.0, 241.0, 108.0 ],
					"id" : "obj-62",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 45.0, 90.0, 250.0, 118.0 ],
					"border" : 1,
					"id" : "obj-65",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"bgcolor" : [ 1.0, 1.0, 1.0, 0.403922 ],
					"patching_rect" : [ 45.0, 213.0, 250.0, 118.0 ],
					"border" : 1,
					"id" : "obj-5",
					"bordercolor" : [ 0.0, 0.0, 0.0, 0.517647 ],
					"rounded" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 315.0, 370.0, 117.0, 26.0 ],
					"border" : 1,
					"id" : "obj-9",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 279.0, 175.0, 18.0 ],
					"id" : "obj-71",
					"outlettype" : [ "jit_matrix", "" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "jit.fpsgui",
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 701.0, 80.0, 36.0 ],
					"id" : "obj-70",
					"outlettype" : [ "", "" ],
					"fontname" : "Arial",
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"patching_rect" : [ 325.0, 440.0, 320.0, 240.0 ],
					"id" : "obj-67",
					"outlettype" : [ "", "" ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 661.0, 225.0, 213.0, 144.0 ],
					"border" : 1,
					"id" : "obj-66",
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Find connected component bounding boxes",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 319.0, 435.0, 335.0, 257.0 ],
					"border" : 1,
					"id" : "obj-147",
					"bordercolor" : [ 0.5, 0.5, 0.5, 0.5 ],
					"rounded" : 15,
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 420.5, 274.5, 334.5, 274.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-8", 1 ],
					"hidden" : 0,
					"midpoints" : [ 334.5, 308.0, 522.5, 308.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-8", 0 ],
					"hidden" : 0,
					"midpoints" : [ 681.5, 405.0, 334.5, 405.0 ]
				}
